...
check_data_completeness <- function(
    ...
    # We don't have output data type (not an extension; it is supposed to be nc/nc4)
    # this line is subject to change, also, the subsetting will be changed accordingly.
    ...
    # 2. na evaluation
    model_output_field_nas = sapply(model_output_sub, function(cl) any(is.na(cl)))
    ...
    if (report_fields_na) {
        cat(paste("Some fields in the model_output are incomplete. Please check:\n   ",
