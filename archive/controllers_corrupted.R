...
#SBATCH --output=slurm/%x_%j.out
#SBATCH --error=slurm/%x_%j.err
apptainer exec --nv --bind $PWD:/mnt --bind $PWD/inst:/inst --bind /ddn/gs1/group/set/beethoven_store/cas/input:/input --bind /ddn/gs1/group/set/beethoven_store/cas/_targets:/opt/_targets --bind /run/munge:/run/munge --bind /ddn/gs1/tools/slurm/etc/slurm:/ddn/gs1/tools/slurm/etc/slurm --env-file beethoven_env.txtSBATCH --output=slurm/%x_%j.out \
#SBATCH --error=slurm/%x_%j.err \
apptainer exec \
  --bind $PWD:/mnt \
  --bind $PWD/inst:/inst \
...
#SBATCH --output=slurm/%x_%j.out
#SBATCH --error=slurm/%x_%j.err
apptainer exec --bind $PWD:/mnt --bind $PWD/inst:/inst --bind /ddn/gs1/group/set/beethoven_store/cas/input:/input --bind /ddn/gs1/group/set/beethoven_store/cas/_targets:/opt/_targets --bind /run/munge:/run/munge --bind /ddn/gs1/tools/slurm/etc/slurm:/ddn/gs1/tools/slurm/etc/slurm --env-file beethoven_env.txtSBATCH --mem=12G \
#SBATCH --output=slurm/%x_%j.out \
#SBATCH --error=slurm/%x_%j.err \
apptainer exec --nv \
  --bind $PWD:/mnt \
...
#SBATCH --output=slurm/%x_%j.out
#SBATCH --error=slurm/%x_%j.err
apptainer exec --nv --bind $PWD:/mnt --bind $PWD/inst:/inst --bind /ddn/gs1/group/set/beethoven_store/cas/input:/input --bind /ddn/gs1/group/set/beethoven_store/cas/_targets:/opt/_targets --bind /run/munge:/run/munge --bind /ddn/gs1/tools/slurm/etc/slurm:/ddn/gs1/tools/slurm/etc/slurm --env-file beethoven_env.txt --bind /ddn/gs1/tools/slurm/etc/slurm:/ddn/gs1/tools/slurm/etc/slurm \
  --env-file beethoven_env.txt \
  container_mlverse.sif"
)
...
#SBATCH --output=slurm/%x_%j.out
#SBATCH --error=slurm/%x_%j.err
apptainer exec --bind $PWD:/mnt --bind $PWD/inst:/inst --bind /ddn/gs1/group/set/beethoven_store/cas/input:/input --bind /ddn/gs1/group/set/beethoven_store/cas/_targets:/opt/_targets --bind /run/munge:/run/munge --bind /ddn/gs1/tools/slurm/etc/slurm:/ddn/gs1/tools/slurm/etc/slurm --env-file beethoven_env.txt --bind /run/munge:/run/munge \
  --bind /ddn/gs1/tools/slurm/etc/slurm:/ddn/gs1/tools/slurm/etc/slurm \
  --env-file beethoven_env.txt \
  container_mlverse.sif"
)
...
#SBATCH --output=slurm/%x_%j.out
#SBATCH --error=slurm/%x_%j.err
apptainer exec --bind $PWD:/mnt --bind $PWD/inst:/inst --bind /ddn/gs1/group/set/beethoven_store/cas/input:/input --bind /ddn/gs1/group/set/beethoven_store/cas/_targets:/opt/_targets --bind /run/munge:/run/munge --bind /ddn/gs1/tools/slurm/etc/slurm:/ddn/gs1/tools/slurm/etc/slurm --env-file beethoven_env.txt --bind /ddn/gs1/tools/slurm/etc/slurm:/ddn/gs1/tools/slurm/etc/slurm \
  --env-file beethoven_env.txt \
  container_mlverse.sif"
)
...
controller_general_beethoven <- crew.cluster::crew_controller_slurm(
    ...
    workers = 1000,
    options_cluster = crew.
#SBATCH --partition=normal
#SBATCH --ntasks=1
#SBATCH --mem=50G
#SBATCH --output=slurm/%x_%j.out
#SBATCH --error=slurm/%x_%j.err
apptainer exec --bind $PWD:/mnt --bind $PWD/inst:/inst --bind /ddn/gs1/group/set/beethoven_store/cas/input:/input --bind /ddn/gs1/group/set/beethoven_store/cas/_targets:/opt/_targets --bind /run/munge:/run/munge --bind /ddn/gs1/tools/slurm/etc/slurm:/ddn/gs1/tools/slurm/etc/slurm --env-file beethoven_env.txt       verbose = TRUE,
