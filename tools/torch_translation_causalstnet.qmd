...
spnn <- simplenn(1, c(32, 64, 24, 4), 1)
spcnn <- simplecnn(16, 1)
sprnn <- simplernn(16, 48, 1)
spnn$parameters


ttn <- torch_tensor(array(rpois(4800, 15), dim = c(4800, 1)), dtype = torch_float32())
ttcn <- torch_tensor(array(rpois(1024 * 24, 42), dim = c(16, 64, 24)), dtype = torch_float32())
tttn <- torch_tensor(array(rpois(1024, 40), dim = c(16, 64)), dtype = torch_float32())
spnn(ttn)
spcnn(ttcn)
sprnn(tttn)
