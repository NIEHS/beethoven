...
- Shell script
  ...
  - `inst/targets/run.sh`: this file is for running the host `targets process **on SLURM by SBATCH script**. The present working directory should be the project root.
- R script
