...
knitr::opts_chunk$set(warning = FALSE, message = FALSE, fig.width = 8, fig.height = 6, res = "retina")
...
ncodt <- data.table::copy(ncostdt$stdt)
index_lblo_sf <- generate_cv_index(ncostdt, "lblo", blocks = eco4d, block_id = "US_L3NAME")
ncodt$lblo_bl <- factor(index_lblo_sf)

index_lblo_tr <- generate_cv_index(ncostdt, "lblo", blocks = terra::vect(eco4d), block_id = "US_L3NAME")
...
# TODO: spatial blocks and temporal folds
