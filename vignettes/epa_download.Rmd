...
```{r}
file_urls <- sprintf(paste("https://aqs.epa.gov/aqsweb/airdata/", resolution,
                           "_", parameter_code, "_%.0f.zip", sep = ""),
                     startyear:endyear)
file_urls
```
...
download_names <- sprintf(paste(download_dir,
                                "download_output_%.0f.zip", sep = ""),
                          startyear:endyear)
download_names
```
#### 2. Downloading data
...
```{r}
csv_names <- sprintf(paste(download_dir, resolution, "_",
                           parameter_code, "_%.0f.csv", sep = ""),
                     startyear:endyear)
```
#### 3. Processing data
