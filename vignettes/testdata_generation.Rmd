...
```{r}
kg_sub <- terra::rast(
  "../tests/testdata/raw/koppen_geiger/Beck_KG_V1_present_0p0083.tif")
terra::plot(kp_sub)
```
...
tri_samp <- data.table::fread(tri_path) |>
  subset(`1. YEAR` == 2022 & `7. COUNTY` %in% c("DURHAM", "WAKE", "ORANGE"))

data.table::fwrite(
  tri_samp,
  "../tests/testdata/raw/tri/durham_wake_orange_tri.csv"
)
```
