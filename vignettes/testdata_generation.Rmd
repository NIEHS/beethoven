...
```{r}
nlcd_sub_2019 <- terra::rast(paste0("../tests/testdata/raw/nlcd/",
                                    "nlcd_2019_land_cover_l48_20210604.tif"))
nlcd_sub_2021 <- terra::rast(paste0("../tests/testdata/raw/nlcd/",
...
```{r}
ecor_sub <- terra::vect(paste0("../tests/testdata/raw/",
...
```{r}
kg_sub <- terra::rast(paste0("../tests/testdata/raw/koppen_geiger/",
...
```{r}
tri_samp <- data.table::fread("../tests/testdata/raw/tri/tri_raw_2022.csv")
head(tri_samp)
```
...
```{r}
aqs_samp <- data.table::fread("../tests/testdata/raw/aqs/daily_88101_2022.csv")
head(aqs_samp)
```
...
```{r}
nei_samp <- data.table::fread("../tests/testdata/raw/NEI/onroad_8910.csv")
head(nei_samp)
```
...
```{r}
smoke_samp <- terra::vect(paste0("../tests/testdata/raw/hms_smoke/",
...
hms_jun18 <- terra::vect(paste0("/Volumes/set/Projects/NRT-AP-Model/input/",
