...
# check_download_function_parameters <- function(a) {
#   if (a$data_download_acknowledgement == FALSE) {
...
#                     "memory.\n")))
#   }
#   if (any(as.vector(unlist(lapply(a, is.null))))) {
#     stop(cat(paste0("One or or more of the parameters provided are `NULL`.\n")))
#   }
# }
